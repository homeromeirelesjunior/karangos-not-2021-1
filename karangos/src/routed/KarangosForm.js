...
export default function KarangosForm() {
    ...
    async function saveData() {
        try {
            await axios.post('https://api.faustocintra.com/karangos', karango)
    ...
    return (
        <>
            ...
            <form className={classes.form} onSubmit={handleSubmit}>
                ...
                <TextField id="cor" label="Cor" variant="filled" value={karango.cor} onChange={event => handleInputChange(event, 'cor')} fullWidth select>
                ...
                <TextField id="ano_fabricacao" label="Ano de Fabricação" variant="filled" value={karango.ano_fabricacao} onChange={event => handleInputChange(event, 'ano_fabricacao')} fullWidth select>
                    {
